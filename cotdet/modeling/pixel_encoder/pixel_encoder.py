...
def build_pixel_decoder(cfg, input_shape):
    """
    Build a pixel decoder from `cfg.MODEL.CoTDet.PIXEL_DECODER_NAME`.
    """
...
class CoTDetEncoder(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.cotdet_num_feature_levels = num_feature_levels  # always use 3 scales
    ...
    def from_config(cls, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        ret["transformer_dropout"] = cfg.MODEL.CoTDet.DROPOUT
        ret["transformer_nheads"] = cfg.MODEL.CoTDet.NHEADS
